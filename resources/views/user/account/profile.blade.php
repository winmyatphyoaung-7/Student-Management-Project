...
@section('content')
    <div class="container">
        <div class="row my-5 d-flex justify-content-center">
            <div class="card p-3 h-auto w-50" >

                <div class="card-header d-flex align-items-center" style="background-color: transparent!important;">
                    <div class="">
                ...
                <div class="card-body">
                    ...
                    <div class=" mt-5 text-center">
                        <a href="{{ route('user#confirmPasswordPage') }}"
                            class="btn btn-outline-info btn-info bg-info text-white ">
