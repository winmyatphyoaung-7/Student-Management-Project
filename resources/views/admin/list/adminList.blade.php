        ...
        <div class="row d-flex justify-content-between align-items-center">
            ...
            <div class="col-6 d-flex">
                <div class="me-3 d-flex align-items-center">
                    ...
                    <a href="{{ route('admin#listPage') }}" type="button"
                        ...
                        <tr class="text-center">
                            <td class="col-3">
                                @if ($data[$d]->image == null)
                                    <img src="{{ asset('img/defaultUser.jpg') }}" class="img-thumbnail"
                                         style="width: 100px!important;" alt="">
                                @else
                                    <img src="{{ asset('storage/' . $data[$d]->image) }}" style="width: 100px!important;" class="img-thumbnail" alt="">
                                @endif
                            </td>
                            <td>
